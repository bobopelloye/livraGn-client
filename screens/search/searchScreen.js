...
import { BackHandler, SafeAreaView, View, TouchableOpacity, StyleSheet, Text, Image, TextInput } from "react-native";
            ...
            <View style={{ marginHorizontal: Sizes.fixPadding }}>
                ...
                {suggestionsList.map((item) => (
                    <View key={`${item.id}`}>
                        <TouchableOpacity
                            activeOpacity={0.9}
                            onPress={() => this.props.navigation.push('RestaurantsList')}
                            style={{
